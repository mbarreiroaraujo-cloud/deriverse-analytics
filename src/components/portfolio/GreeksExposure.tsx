  ...
  return (
    <div className="bg-bg-secondary/80 border border-border/50 rounded-2xl p-4 sm:p-6 shadow-sm shadow-black/20 card-hover">
      <div className="mb-4 sm:mb-5">
        ...
        <p className="text-[10px] sm:text-xs text-text-muted mt-0.5 hidden sm:block">Aggregate options risk across portfolio</p>
      </div>
          ...
          return (
            <div key={key}>
              <div className="flex items-center justify-between mb-1">
                ...
                <span className="text-[11px] sm:text-sm font-mono font-semibold text-text-primary" style={{ fontVariantNumeric: 'tabular-nums' }}>
