...
function CustomTooltip({ active, payload }: { active?: boolean; payload?: Array<{ payload: OrderTypeData }> }) {
...
export function OrderTypeAnalysis() {
  ...
  const data: OrderTypeData[] = Object.entries(metrics.byOrderType).map(([type, m], i) => ({
