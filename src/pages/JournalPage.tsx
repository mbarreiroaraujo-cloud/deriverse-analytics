    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <div className="bg-bg-secondary/80 border border-border/50 rounded-2xl p-6 shadow-sm shadow-black/20 card-hover">
          <h3 className="text-sm font-semibold text-text-primary mb-3">Emotion Performance</h3>
          <p className="text-xs text-text-muted mb-4">Win rate by emotional state ({withJournal.length} tagged trades)</p>
        ...
        {/* Setup breakdown */}
        <div className="bg-bg-secondary/80 border border-border/50 rounded-2xl p-6 shadow-sm shadow-black/20 card-hover">
          <h3 className="text-sm font-semibold text-text-primary mb-3">Setup Performance</h3>
          <p className="text-xs text-text-muted mb-4">Win rate by trade setup type</p>
          <div className="space-y-2.5">
        ...
        {/* Grade breakdown */}
        <div className="bg-bg-secondary/80 border border-border/50 rounded-2xl p-6 shadow-sm shadow-black/20 card-hover">
          <h3 className="text-sm font-semibold text-text-primary mb-3">Grade Performance</h3>
          <p className="text-xs text-text-muted mb-4">PnL by execution quality grade</p>
          <div className="space-y-2.5">
            {['A', 'B', 'C', 'D'].map(grade => {
